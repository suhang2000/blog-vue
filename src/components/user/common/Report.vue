<template>
  ...
  <el-form ref="reportInfo" :model="reportInfo" :rules="rules" class="regis-container" label-position="left"
    ...
    <h3 class="regis_title">将举报博客标题为：{{ title }}</h3>
    <div class="block">
    ...
    <el-form-item prop="description">
      <el-input type="text" v-model="reportInfo.description"
                auto-complete="off" placeholder="详细描述"></el-input>
    </el-form-item>
    ...
    <el-form-item style="width: 100%">
      <el-button type="primary" style="width: 40%;background: #505458;border: none" @click="report('reportInfo')">修改</el-button>
    </el-form-item>
  </el-form>
  </body>
</template>
  ...
  import {validatePhone, validateEmail} from '../../utils/validate'
    export default {
        ...
        created() {
            ...
            this.reportInfo.title = temp.title;
